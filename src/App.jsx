...
//     setError(null);
//     try {
//       const url = `https://api.github.com/repos/GitProductions/EsportsDashBoard/contents/${repoPath}`;
...
//     setError(null);
//     try {
//       const url = `https://api.github.com/repos/GitProductions/EsportsDashBoard/contents/${folderPath}`;
//       const response = await fetch(url, { headers: { Accept: "application/vnd.github.v3+json" } });
//       if (!response.ok) {
...
//   const renderMenu = () => (
//     <div className="menu">
//       <h1>GitHub Directory Explorer</h1>
//       <p>Select a folder to explore:</p>
//       <div>
//         <button onClick={() => { setView("gameConfigs"); fetchFolders("Game%20Configs"); }}>
//           Explore Game Configs
//         </button>
//         <button onClick={() => { setView("htmlPacks"); fetchFolders("HTML%20Packs"); }}>
//           Explore HTML Packs
//         </button>
//       </div>
//     </div>
...
//             <h3>{folder.name}</h3>
//             <button onClick={() => fetchFiles(`Game%20Configs/${folder.name}`)}>View .bgg Files</button>
//           </div>
//         ))}
//       </div>
//       {files.length > 0 && (
...
//               <p>{file.name}</p>
//               <a href={file.download_url} target="_blank" rel="noopener noreferrer" className="download-link">
//                 Download
//               </a>
//             </div>
//           ))}
...
//           <div key={folder.name} className="folder">
//             <h3>{folder.name}</h3>
//             <a href={`https://downgit.github.io/#/home?url=${folder.html_url}`} target="_blank" rel="noopener noreferrer" className="download-link">
//               Download Folder
//             </a>
//           </div>
//         ))}
